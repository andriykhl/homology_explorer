...
function change_glyph_btn1() {
  if(show_labels==true)
    button1.style.backgroundImage = `url("./icons/btn_1_off.png")`;
  else
    button1.style.backgroundImage = `url("./icons/btn_1_off.png")`;
}
...
function change_glyph_btn2() {
  if(show_negative==true)
    button2.style.backgroundImage = `url("./icons/btn_2_off.png")`;
  else
    button2.style.backgroundImage = `url("./icons/btn_2_on.png")`;
}

function change_glyph_btn3() {
  if(show_connections==true)
    button3.style.backgroundImage = `url("./icons/btn_3_on.png")`;
  else
    button3.style.backgroundImage = `url("./icons/btn_3_off.png")`;
}
